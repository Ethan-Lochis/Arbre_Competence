...
import { AccueilPage } from "./pages/Accueil/page.js";
...
import {SVG_Competence} from "./pages/svg-Competence/page.js";
...
router.addRoute("/svg-Competence", SVG_Competence);
